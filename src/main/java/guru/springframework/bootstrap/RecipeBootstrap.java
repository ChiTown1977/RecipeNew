...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository) {
        ...
        log.debug("Bootstrap Constructor Initialized");
    }
    ...
    public boolean equals(Object o) {
        ...
        final Object this$categoryRepository = this.categoryRepository;
        final Object other$categoryRepository = other.categoryRepository;
        if (this$categoryRepository == null ? other$categoryRepository != null : !this$categoryRepository.equals(other$categoryRepository))
            return false;
        final Object this$recipeRepository = this.recipeRepository;
        final Object other$recipeRepository = other.recipeRepository;
        if (this$recipeRepository == null ? other$recipeRepository != null : !this$recipeRepository.equals(other$recipeRepository))
            return false;
        final Object this$unitOfMeasureRepository = this.unitOfMeasureRepository;
        final Object other$unitOfMeasureRepository = other.unitOfMeasureRepository;
    ...
    public int hashCode() {
        final int PRIME = 59;
        int result = 1;
        final Object $categoryRepository = this.categoryRepository;
        result = result * PRIME + ($categoryRepository == null ? 43 : $categoryRepository.hashCode());
        final Object $recipeRepository = this.recipeRepository;
        result = result * PRIME + ($recipeRepository == null ? 43 : $recipeRepository.hashCode());
        final Object $unitOfMeasureRepository = this.unitOfMeasureRepository;
        result = result * PRIME + ($unitOfMeasureRepository == null ? 43 : $unitOfMeasureRepository.hashCode());
        return result;
    }

    public String toString() {
        return "RecipeBootstrap(categoryRepository=" + this.categoryRepository + ", recipeRepository=" + this.recipeRepository + ", unitOfMeasureRepository=" + this.unitOfMeasureRepository + ")";
    }
}
